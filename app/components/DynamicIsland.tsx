            ...
            >
                ...
                >
                    ...
                    <div className="grid grid-cols-3 gap-1.5 sm:gap-2">
                        {/* Happy Hours / Zomato */}
                        <button onClick={(e) => { e.stopPropagation(); scrollTo('refuel'); }} className="bg-white/5 hover:bg-orange-500/20 border border-white/5 hover:border-orange-500/50 hover:shadow-[0_0_15px_rgba(249,115,22,0.3)] rounded-xl p-1.5 sm:p-3 flex items-center justify-center transition-all duration-300 group">
                            <span className="text-white text-[9px] sm:text-xs font-bold group-hover:text-orange-400 transition-colors">Happy Hours</span>
                        </button>

                        {/* Gaming */}
                        <button onClick={(e) => { e.stopPropagation(); scrollTo('gaming'); }} className="bg-white/5 hover:bg-cyan-500/20 border border-white/5 hover:border-cyan-500/50 hover:shadow-[0_0_15px_rgba(34,211,238,0.3)] rounded-xl p-1.5 sm:p-3 flex items-center justify-center transition-all duration-300 group">
                            <span className="text-white text-[9px] sm:text-xs font-bold group-hover:text-cyan-400 transition-colors">Games</span>
                        </button>

                        {/* Cafe */}
                        <button onClick={(e) => { e.stopPropagation(); scrollTo('food'); }} className="bg-white/5 hover:bg-pink-500/20 border border-white/5 hover:border-pink-500/50 hover:shadow-[0_0_15px_rgba(236,72,153,0.3)] rounded-xl p-1.5 sm:p-3 flex items-center justify-center transition-all duration-300 group">
                            <span className="text-white text-[9px] sm:text-xs font-bold group-hover:text-pink-400 transition-colors">Cafe</span>
                        </button>

                        {/* Book a Party */}
                        <button onClick={(e) => { e.stopPropagation(); scrollTo('events'); }} className="bg-white/5 hover:bg-purple-500/20 border border-white/5 hover:border-purple-500/50 hover:shadow-[0_0_15px_rgba(168,85,247,0.3)] rounded-xl p-1.5 sm:p-3 flex items-center justify-center transition-all duration-300 group">
                        ...
                        {/* Buy Merch */}
                        <button onClick={(e) => { e.stopPropagation(); scrollTo('merch'); }} className="bg-white/5 hover:bg-emerald-500/20 border border-white/5 hover:border-emerald-500/50 hover:shadow-[0_0_15px_rgba(16,185,129,0.3)] rounded-xl p-1.5 sm:p-3 flex items-center justify-center transition-all duration-300 group">
                            <span className="text-white text-[9px] sm:text-xs font-bold group-hover:text-emerald-400 transition-colors">Merch</span>
                        </button>
                    </div>
